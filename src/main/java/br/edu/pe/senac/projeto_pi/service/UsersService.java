...
public class UsersService {
    ...
    public void remover(Long id) {
        ...
        logSistemaRepository.deleteAll(logSistemaRepository.findByUserId(id));
        notificacaoRepository.deleteAll(notificacaoRepository.findByUserId(id));
        certificadoRepository.deleteAll(certificadoRepository.findByAlunoId(id));
        atividadeRepository.deleteAll(atividadeRepository.findByAlunoId(id));
